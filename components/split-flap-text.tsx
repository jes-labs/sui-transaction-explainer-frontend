...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
    ...
    const bgColor = isSettled ? "hsl(0, 0%, 0%)" : "rgba(6, 182, 212, 0.2)" // Modified: Orange -> Cyan (rgba(6, 182, 212, 0.2))
    const textColor = isSettled ? "#ffffff" : "#06B6D4" // Modified: Orange -> Cyan (#06B6D4)
